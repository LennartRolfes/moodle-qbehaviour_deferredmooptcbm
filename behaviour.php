...
/**
 * Question behaviour that is like the deferred feedback model for MooPT questions, but with
...
require_once(__DIR__ . '/../deferredmoopt/behaviour.php');


/**
 * Question behaviour for deferred feedback with certainty based marking for MooPT questions.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qbehaviour_deferredmooptcbm extends qbehaviour_deferredmoopt {
