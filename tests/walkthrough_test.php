...
class walkthrough_test extends \qbehaviour_walkthrough_test_base {
    public function test_deferred_moopt_cbm_truefalse_high_certainty() {

        // Create a true-false question with correct answer true.
        $tf = \test_question_maker::make_question('truefalse', 'true');
        $this->start_attempt_at_question($tf, 'deferredmooptcbm', 2);
    ...
    public function test_deferred_moopt_cbm_truefalse_low_certainty() {
    ...
    public function test_deferred_moopt_cbm_truefalse_default_certainty() {
        ...
        $this->check_current_output($this->get_contains_correct_expectation(),
                ...
                new \question_pattern_expectation('/' . preg_quote(
                        get_string('assumingcertainty', 'qbehaviour_deferredmooptcbm',
    ...
    public function test_deferredmooptcbm_resume_multichoice_single() {

        // Create a multiple-choice question.
        $mc = \test_question_maker::make_a_multichoice_single_question();

        // Attempt it getting it wrong.
        $this->start_attempt_at_question($mc, 'deferredmooptcbm', 1);
    ...
    public function test_deferred_moopt_cbm_truefalse_no_certainty_feedback_when_not_answered() {
